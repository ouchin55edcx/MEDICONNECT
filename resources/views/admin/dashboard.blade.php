                ...
                @foreach ($specialties as $specialty)
                    <div x-data="{ showModal: false, editedSpecialty: '{{ $specialty->specialtyName }}' }">
                        ...
                        <div x-show="showModal" class="fixed inset-0 z-50 overflow-auto bg-smoke">
                            <div x-show="showModal" class="fixed inset-0 transition-opacity" x-transition:enter="ease-out duration-300"
                                x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
                                x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100"
                                x-transition:leave-end="opacity-0" @click="showModal = false"></div>
                                ...
                                <div class="bg-white p-8 mx-4 rounded-lg max-w-md w-full">
                                    ...
                                    <form action="{{ route('specialties.update', $specialty) }}" method="POST">
                                        ...
                                        <div class="flex justify-end">
                                            ...
                                            <button type="submit" class="button bg-blue-500 text-white hover:bg-blue-700 px-3 py-1 rounded">
                                                Update
                                            </button>
                                        </div>
                                    </form>
